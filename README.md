...
```html
<!--增强版SDK-->
<script src="https://code.bdstatic.com/npm/spy-client@2.1.7/dist/spy-client.min.js" type="text/javascript"></script>

<!--增强版SDK spy-head-->
<script src="https://code.bdstatic.com/npm/spy-client@2.1.7/dist/spy-head.min.js" type="text/javascript"></script>

<!--基础版SDK-->
<script src="https://code.bdstatic.com/npm/spy-client@2.1.7/dist/spy-client-basic.min.js" type="text/javascript"></script>
